...
document.querySelectorAll("#detection-settings input").forEach((slider) => {
  ...
  slider.addEventListener("input", ()=>{
    sliderlabel = slider.labels[0];
    sliderlabel.innerHTML = `${slider.id}: ${slider.value}`
    console.log(sliderlabel.innerHTML)
  });
...
document.querySelectorAll("#image-filters input").forEach((slider) => {
  ...
  slider.addEventListener("input", ()=>{
    sliderlabel = slider.labels[0];
    sliderlabel.innerHTML = `${slider.name}: ${slider.value}`
    console.log(sliderlabel.innerHTML)
  });
